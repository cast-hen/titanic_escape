...
cube3_Enemy1 = Objects(1040, -190, 100, 300, 'orange', 1, 0, 0, [3], enemyBOBJAN_1)
...
cube4_Enemy1 = Objects(640, -100, 100, 300, 'orange', 1, 0, 0, [4], enemyBOBBOBBOB_1)
...
cube6_Enemy1 = Objects(590, 360, 100, 300, 'orange', 1, 0, 0, [6], enemyBobbie_1)
...
cube9_Enemy1 = Objects(825, 85, 100, 400, 'orange', 1, 0, 0, [9], enemyWillem_1)
...
cube10_Enemy1 = Objects(485, 93, 100, 300, 'orange', 1, 0, 0, [10], enemyAlexander_1)
...
cube14_Enemy1 = Objects(69, 440, 100, 400, 'orange', 1, 0, 0, [14], enemyWillem_Henk_1)
cube14_Enemy2 = Objects(880, 440, 100, 400, 'orange', 1, 0, 0, [14], enemyBoze_Janje_1)
...
cube16_Enemy1 = Objects(950, 164, 160, 370, 'orange', 1, 0, 0, [16], enemyKwaardaardige_BOB_1)
...
cube20_Enemy1 = Objects(519, 98, 186, 302, 'orange', 1, 0, 0, [20], enemyBoudewijn_1)
cube20_Enemy2 = Objects(750, 98, 186, 302, 'orange', 1, 0, 0, [20], enemyRoderick_1)
...
cube23_Enemy1 = Objects(493, 490, 100, 169, 'orange', 1, 0, 0, [23], enemyKleine_Karel_1)
cube23_Enemy2 = Objects(1128, 491, 106, 210, 'orange', 1, 0, 0, [23], enemyIni_Mini_1)
